...
public final class FragmentSettingsBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialCardView cardPreferences;

  @NonNull
  public final SwitchMaterial switchCurrency;
  ...
  private FragmentSettingsBinding(@NonNull CoordinatorLayout rootView,
      @NonNull MaterialCardView cardAbout, @NonNull MaterialCardView cardPreferences,
      @NonNull SwitchMaterial switchCurrency, @NonNull SwitchMaterial switchDarkMode,
      @NonNull SwitchMaterial switchNotifications, @NonNull TextView textViewAbout,
      @NonNull TextView textViewPreferences) {
  ...
  public static FragmentSettingsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.cardPreferences;
      MaterialCardView cardPreferences = ViewBindings.findChildViewById(rootView, id);
      if (cardPreferences == null) {
        break missingId;
      }

      id = R.id.switchCurrency;
      SwitchMaterial switchCurrency = ViewBindings.findChildViewById(rootView, id);
      if (switchCurrency == null) {
        break missingId;
      }
      ...
      TextView textViewPreferences = ViewBindings.findChildViewById(rootView, id);
      if (textViewPreferences == null) {
        break missingId;
      }

      return new FragmentSettingsBinding((CoordinatorLayout) rootView, cardAbout, cardPreferences,
          switchCurrency, switchDarkMode, switchNotifications, textViewAbout, textViewPreferences);
    }
